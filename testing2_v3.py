...
class GeneticAlgorithm:
  def __init__(self, chromosome_length: int, obj_func_num_args: int, objective_function, aoi, population_size=10,
               tournament_size=2, mutation_probability=1, crossover_probability=0.5, num_steps=30):
  ...
  def decode_chrom(self, chromosome):
